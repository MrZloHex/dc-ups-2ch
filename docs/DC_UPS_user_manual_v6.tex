...
Пока устройство загружается и подключается к Wi-Fi, зелёный LED мигает с частотой около 2~Гц. Когда активна точка настройки, оба LED медленно чередуются (зелёный/красный, по 500~мс).
