...
// Shared declarations. Definitions of the globals live in ups_common.cpp,
// module-owned state lives in the matching module header.
#pragma once
...
// 100k/10k divider → x11. Sense pins must be on ADC1 (GPIO32..39).
